  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.tagline}>Start cooking smarter today</Text>
        ...
        <View style={styles.card}>
          ...
          {[
            { label: 'Your Name', value: displayName, setter: setDisplayName, placeholder: 'Chef Jane', secure: false, keyboard: 'default' as const },
            { label: 'Email', value: email, setter: setEmail, placeholder: 'you@example.com', secure: false, keyboard: 'email-address' as const },
            { label: 'Password', value: password, setter: setPassword, placeholder: '••••••••', secure: true, keyboard: 'default' as const },
            { label: 'Confirm Password', value: confirm, setter: setConfirm, placeholder: '••••••••', secure: true, keyboard: 'default' as const },
...
const styles = StyleSheet.create({
  ...
  logo: { fontSize: 36 },
  appName: { fontSize: 32, fontWeight: '800', color: Colors.onSurface, fontStyle: 'italic', letterSpacing: -0.5 },
  tagline: { fontSize: 15, color: Colors.onSurfaceVariant, marginBottom: 32 },
  card: {
    width: '100%',
  ...
  buttonText: { color: Colors.onPrimary, fontSize: 16, fontWeight: '700', letterSpacing: 0.3 },
  footer: { flexDirection: 'row', justifyContent: 'center', marginTop: 20 },
  footerText: { color: Colors.onSurfaceVariant, fontSize: 14 },
  footerLink: { color: Colors.primary, fontSize: 14, fontWeight: '700' },
  legal: { marginTop: 24, fontSize: 11, color: Colors.outline, textAlign: 'center', lineHeight: 16 },
});
